...
2.  für die Extrahandelsstatistik
    ...
    b)  EORI-Nummer, ergänzende nationale Niederlassungsnummer zur EORI-
        Nummer, TCUI-
        Nummer, IOSS-Nummer, Steuernummer der Auskunftspflichtigen aus der
        Umsatzsteuer-
        Voranmeldung, Umsatzsteuer-Identifikationsnummer der
        Auskunftspflichtigen, Registriernummer der Zollanmeldung, sowie
        weitere, aufgrund einer Rechtsverordnung nach § 18 Nummer 3
        festgelegte Identifikatoren,
