...
## Anlage 1 Prüfliste für Straßenkontrollen
[Direktlink](https://www.gesetze-im-internet.de/ggkontrollv/BJNR130600997.html#BJNR130600997BJNE000904119)

(Fundstelle: BGBl. 2026 I Nr. 200, S. 5 – 6)

*    *   1.

    *   Ort und Land der Kontrolle:
...
*    *   4.
    ...
    *   Länderkennzeichen und Zulassungsnummer(n) des Fahrzeugs/der Fahrzeuge

    *

*    *   5.

    *   Transportunternehmen/Anschrift:

    *

*    *   6.

    *[^F836704_02_BJNR130600997BJNE000904119]
   Name(n) der Fahrer/Beifahrer und deren Bescheinigungsnummern
        (ADR 8.2, falls zutreffend):

    *

*    *   7.

    *   Anschrift und Datum der letzten Be- oder Entladung:

    *

*    *   8.

    *   Anschrift und Datum der nächsten Be- oder Entladung:

    *

*    *   9.

    *[^F836704_03_BJNR130600997BJNE000904119]
   UN-Nummer, Verpackungsgruppe und Menge der Gefahrgüter, bei denen
...
*    *   10.
    ...
    *[^F836704_04_BJNR130600997BJNE000904119]
   Befreiung anwendbar und, wenn ja, welche?
...
*    *   **Dokumente**
    ...
    *[^F836704_05_BJNR130600997BJNE000904119]
   Prüfstatus

    *   Verstoß

    *[^F836704_07_BJNR130600997BJNE000904119]
   ADR-Abschnitt + Beteiligte
...
*    *
    ...
    *   Gefahren-
[^F836704_06_BJNR130600997BJNE000904119]
        kategorie
...
*    *   12.
    ...
    *   Beförderungspapiere (wie ADR 8.1.2.1 Buchstabe a, 5.4.1, 5.4.2)
...
*    *   13.
    ...
    *   Schriftliche Weisungen (ADR 8.1.2.1 Buchstabe b, 5.4.3)
...
*    *   14.
    ...
    *   Zulassungsbescheinigung für Fahrzeuge (ADR 8.1.2.2 Buchstabe a, 9.1.3)
...
*    *   15.
    ...
    *   Schulungsbescheinigung des
        Fahrers (ADR 8.1.2.2 Buchstabe b) und Ausweisdokument (ADR 1.10.1.4,
        8\.1.2.1 Buchstabe d)
...
*    *   16.
    ...
    *   Zur Beförderung zugelassene Güter (ADR 1.1.2.1)
...
*    *   17.
    ...
    *   Umschließungsmittel (wie ADR 4.1 bis 4.7)
...
*    *   18.
    ...
    *   Beförderungsvorschriften (wie ADR 7.1 bis 7.4)
...
*    *   19.
    ...
    *   Zusammenladungsverbote und Mengenbegrenzungen (wie ADR 7.5.2, 7.5.4,
        7\.5.5)
...
*    *   20.
    ...
    *   Handhabung und Verstauung (wie ADR 7.5.7)
...
*    *   21.
    ...
    *   Kennzeichnung des Versandstücks/Tanks/Schüttguts (wie ADR Teil 6)
...
*    *   22.
    ...
    *   Kennzeichnung und Bezettelung von Versandstücken (wie ADR 3.3 bis 3.5,
        4\.1.4.1, 5.1, 5.2)
...
*    *   23.
    ...
    *   Großzettel (Placards), organgefarbene Tafeln, Kennzeichnung von
        Fahrzeugen/Tanks usw. (wie ADR 3.4.13, 5.3, 5.5, 7.3, 7.5.11)
...
*    *   24.
    ...
    *   Fahrzeuganforderungen (ADR Teil 9)
...
*    *   25.
    ...
    *   Allgemeine und spezifische Ausrüstung (wie ADR 8.1.4, 8.1.5)
...
*    *   26.
    ...
    *   Bilaterale/multilaterale Vereinbarungen (wie ADR 1.5.1),
...
*    *   29.
    ...
    *[^F836704_08_BJNR130600997BJNE000904119]
   Anmerkungen
        :
...
*    *   31.
    ...
    *   Behörde/Beamter/delegierte Stelle, die/der die Kontrolle durchgeführt
        hat
...
[^F836704_02_BJNR130600997BJNE000904119]:     Weitere Angaben unter „Anmerkungen“.
[^F836704_03_BJNR130600997BJNE000904119]:     Bezieht sich auf alle Befreiungen oder Ausnahmen gemäß der Richtlinie
    2008/68/EG.
[^F836704_04_BJNR130600997BJNE000904119]:     Prüfstatus: G = geprüft, n. m. = Prüfung nicht möglich, n. z. = nicht
    zutreffend.
[^F836704_05_BJNR130600997BJNE000904119]:     Gefahrenkategorie des festgestellten Verstoßes gemäß Anhang II.
[^F836704_06_BJNR130600997BJNE000904119]:     Bei Feststellung von Verstößen auszufüllen. Geben Sie die Kategorie
    des/der möglichen verantwortlichen Beteiligten gemäß ADR 1.4 an: Abs =
    Absender, Befö = Beförderer, Empf = Empfänger, Verl = Verlader, Verp =
    Verpacker, Befü = Befüller, TB = Tankbetreiber, Entl = Entlader. Die
    Nennung der Kategorie des Beteiligten in der Prüfliste berührt in
    keiner Weise die Unschuldsvermutung.
[^F836704_07_BJNR130600997BJNE000904119]:     Bitte geben Sie hier die UN-Nummer(n), Verpackungsgruppe, Menge der
    beförderten gefährlichen Güter, sofern Verstöße festgestellt wurden,
    Verstöße des Fahrpersonals, Abhilfemaßnahmen und sonstige Bemerkungen
    an.
[^F836704_08_BJNR130600997BJNE000904119]: 
...
## Anlage 3 Verstöße
[Direktlink](https://www.gesetze-im-internet.de/ggkontrollv/BJNR130600997.html#BJNR130600997BJNE001104119)
...
Die angemessene Gefahrenkategorie wird unter Berücksichtigung der
besonderen Umstände eines Verstoßes festgelegt und liegt im Ermessen
der Vollstreckungsbehörde bzw. des Vollstreckungsbeamten, was
bedeutet, dass ein Verstoß in eine höhere oder niedrigere
...
A.  Gefahrenkategorie I
    ...
    Verstöße bei Straßenkontrollen festgestellt, müssen diese in der Regel
    zu unverzüglichen und geeigneten Abhilfemaßnahmen führen,
    ...
    12. Nichteinhaltung der Vorschriften für die Sicherung und Verstauung der
        Ladung,
    ...
    16. Beförderung gefährlicher Güter ohne die erforderlichen Dokumente an
        Bord oder in einem ungeeigneten elektronischen Format, sofern
        zulässig,
    ...
    18. Beförderung gefährlicher Güter ohne Anbringung von Großzetteln
        (Placards) oder Kennzeichen (einschließlich orangefarbener Tafeln) am
        Fahrzeug,
...
B.  Gefahrenkategorie II
    ...
    9.  Tanks, Fahrzeuge, Container oder Versandstücke mit falschen
        Bezettelungen, Kennzeichen (einschließlich orangefarbener Tafeln) oder
        Großzetteln,
...
C.  Gefahrenkategorie III
    ...
    Diese Kategorie betrifft Verstöße gegen ADR-Vorschriften, bei denen
    eine geringe Gefahr von Verletzungen oder einer Schädigung der Umwelt
    besteht und geeignete Abhilfemaßnahmen nicht an der Straße ergriffen
    werden müssen, sondern zu einem späteren Zeitpunkt auf dem
    ...
    1.  Nichteinhaltung der Vorschriften über die Größe von Großzetteln
        (Placards), Gefahrzetteln oder anderer Kennzeichen oder über die Größe
        von Buchstaben, Zahlen oder Symbolen auf den Großzetteln,
