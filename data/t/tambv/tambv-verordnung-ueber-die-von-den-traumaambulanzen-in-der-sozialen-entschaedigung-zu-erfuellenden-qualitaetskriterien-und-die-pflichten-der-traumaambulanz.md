...
*    *   **Komorbide Symptomatik** (z. B. Suchterkrankung, Angststörung, andere
        psychische Erkrankungen und sekundärpsychotische Phänomene)
...
*    *   Die Vermittlung von Therapiestrategien soll methodenübergreifend und
        integrativ erfolgen.
...
*    *
    *   Es sollen eine traumafokussierte Vorgehensweise detailliert **in
        ...
        Differentialindikation) **und Praxis** (praktische Übungen,
        Beherrschen des Behandlungsprotokolls) vermittelt werden (24 h). Ein
        anderes Therapieverfahren soll im Überblick mit Fokus auf
        Gemeinsamkeiten evidenzbasierter Therapieverfahren vorgestellt werden
        und unterschiedliche Zugänge die das Erlernen der Hauptmethode
        unterstützend vertiefen können (8 h). Nähere Ausführungen dazu siehe
        unten. Die Behandlung sollte in Theorie (Krankheitsmodelle,
...
*    *
    *
        ...
        –   Möglichkeiten und Grenzen von therapeutischen Interventionen bei
            ...
            psychological first aid“ und Mental Health
            Psychosocial Support (MHPSS). Umgang mit Krisensituationen bei
            neuerlichen Belastungen
